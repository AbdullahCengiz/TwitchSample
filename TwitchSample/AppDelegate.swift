...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        do {
            TwitchSampleCommunicator.sharedInstance.reach =  try Reachability.reachabilityForInternetConnection();
            try TwitchSampleCommunicator.sharedInstance.reach.startNotifier();
        }
        catch {
